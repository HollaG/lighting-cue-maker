 ...
 * @returns
 */
export const VisualiserMovingLightObject = React.memo(
  ({
    fixture,
    isSelected,
    onSelect,
    ...
    const { tilt, pan } = positionAttribute ?? { tilt: 0, pan: 0 };
    ...
    return (
      <React.Fragment>
        ...
        {positionAttribute && showGuideLines && (
        ...
        >
          ...
          <Arc
            ...
            stroke={"#ffffff"}
            fill={fillColour}
            rotation={-beamAngle / 2 - 90 + (positionAttribute ? pan2D : 0)}
